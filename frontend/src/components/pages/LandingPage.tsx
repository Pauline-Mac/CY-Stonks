...
function MainTitle(): React.ReactElement {
  return (
    <header className='flex justify-between'>
      <h2 className='text-2xl font-semibold italic'>Suivez, Analysez et Faites Croître Votre Patrimoine</h2>
      <div className="">
        <input type="text" className="outline-none" placeholder="🕵️‍♀️ Chercher en bourse" />
      </div>
    </header>
  );
}
